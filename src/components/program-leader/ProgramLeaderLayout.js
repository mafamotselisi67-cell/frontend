...
//                             onClick={() => navigate('/program-leader/reports')}
//                         >
//                             📋 Reports
//                         </Nav.Link>
//                         <Nav.Link 
//                             className={`text-white p-3 ${isActive('monitoring') ? 'bg-primary' : ''}`}
//                             onClick={() => navigate('/program-leader/monitoring')}
//                         >
//                             📈 Monitoring
//                         </Nav.Link>
//                         <Nav.Link 
//                             className={`text-white p-3 ${isActive('classes') ? 'bg-primary' : ''}`}
//                             onClick={() => navigate('/program-leader/classes')}
//                         >
//                             📚 Classes
//                         </Nav.Link>
//                         <Nav.Link 
//                             className={`text-white p-3 ${isActive('lectures') ? 'bg-primary' : ''}`}
//                             onClick={() => navigate('/program-leader/lectures')}
//                         >
//                             👨‍🏫 Lectures
//                         </Nav.Link>
//                         <Nav.Link 
//                             className={`text-white p-3 ${isActive('rating') ? 'bg-primary' : ''}`}
//                             onClick={() => navigate('/program-leader/rating')}
//                         >
//                             ⭐ Rating
//                         </Nav.Link>
//                         <Nav.Link 
...
// export default ProgramLeaderLayout;